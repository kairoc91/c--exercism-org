...
public static string Message(this string textoDoLog) => textoDoLog.SubstringAfter(": ");
    
    // TODO: define the 'LogLevel()' extension method on the `string` type
public static string LogLevel(this string textoDoLog) => textoDoLog.SubstringBetween("[","]");
